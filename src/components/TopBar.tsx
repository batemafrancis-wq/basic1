...
export default function TopBar() {
  ...
  return (
    <header className={`sticky top-0 z-20 h-16 flex items-center justify-between px-6 border-b backdrop-blur-xl ${
      isDarkMode
      ...
      <div
        className={`flex items-center gap-1 p-1 rounded-xl backdrop-blur-xl border ${
          isDarkMode
      ...
      <div className="flex items-center gap-2">
        {/* Search */}
        <button className={`flex items-center gap-2 px-3 py-2 rounded-xl border text-sm transition-all ${
          isDarkMode
          ...
          <kbd className={`hidden md:block text-[10px] px-1.5 py-0.5 rounded border font-mono ${
            isDarkMode ? 'border-slate-600 text-slate-500' : 'border-slate-200 text-slate-400'
          }`}>⌘K</kbd>
        </button>
